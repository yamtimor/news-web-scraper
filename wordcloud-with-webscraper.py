...
wordcloud = wc.WordCloud(background_color="mintcream",font_path="C:\Windows\Fonts\gisha.ttf",stopwords= mystopwordslist).generate(news)
plt.style.use('seaborn-pastel')
plt.figure(figsize=(8, 8))
plt.axis('off')
plt.imshow(wordcloud)
plt.title("Ynet WordCloud", fontsize = 20)
plt.show()
